...
base_params = {
    ...
    "depth": 1.0,                # Analysis thoroughness (0.1 surface scan — 1.0 deep exploration)
    "iterations_max": 7,         # Reasoning cycles (1 quick response — 7 thorough analysis)
    "confidence_target": 0.8,    # Quality threshold (0.5 speed priority — 0.95 precision priority)
